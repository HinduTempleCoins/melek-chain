...
fc::variant_object get_config()
{
   ...
   result["STEEM_VOTES_PER_PERIOD_SMT_HF"] = STEEM_VOTES_PER_PERIOD_SMT_HF;
   ...
   result["STEEM_NETWORK_TYPE"] = STEEM_NETWORK_TYPE;
   result["STEEM_DB_FORMAT_VERSION"] = STEEM_DB_FORMAT_VERSION;
